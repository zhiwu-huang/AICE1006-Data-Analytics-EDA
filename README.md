...
The lectures are [jupyter](https://jupyter.org/) notebooks to be presented as slides using either [rise](https://rise.readthedocs.io/en/stable/) or related "jupyter nbconvert"  command.
